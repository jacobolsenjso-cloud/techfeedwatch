...
faqs:
  - question: "What are AI tokens?"
    answer: "AI tokens are the basic units of consumption for artificial intelligence models. Every interaction with an AI, such as asking a question, receiving an answer, or generating code, consumes a certain number of tokens, which represent the computational effort involved."
  - question: "Why is 'tokenmaxxing' a problem for AI demand forecasting?"
    answer: "Tokenmaxxing occurs when employees are incentivized to maximize their AI usage, often measured by token consumption, rather than focusing on productive output. This practice inflates demand signals because it encourages inefficient or unnecessary AI use, leading to an inaccurate picture of genuine business need."
  - question: "How do AI agents impact token consumption and budgeting?"
    answer: "AI agents, which can perform complex tasks autonomously for extended periods, consume tokens at a much faster rate than simple chatbots. This rapid consumption can quickly deplete budgets, making flat-rate plans unsustainable and leading to significant cost overruns if not properly managed with per-token billing."
  - question: "What are the risks of overestimating AI demand for the industry?"
    answer: "Overestimating AI demand can lead to inflated valuations for AI companies and significant overinvestment in infrastructure like data centers and specialized chips. If actual demand does not match these projections, the industry could face a correction, with infrastructure built for unreal numbers and financial returns failing to materialize."
