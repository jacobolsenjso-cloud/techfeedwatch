...
isShort: false
faqs:
  - question: "What is agentic AI in banking?"
    answer: "Agentic AI refers to artificial intelligence systems that can autonomously manage and move money. These AI agents operate within constraints set by the user, actively seeking out optimal financial opportunities like higher yields or faster payment routes without constant human intervention."
  - question: "How does tokenization affect financial assets?"
    answer: "Tokenization transforms traditional assets, such as real estate deeds, company stocks, or government bonds, into digital tokens on a blockchain. This allows these assets to be traded, transferred, and managed on-chain, making transactions potentially faster, more transparent, and more accessible across digital networks."
  - question: "What role do open finance APIs play in decentralized AI banking?"
    answer: "Open finance APIs (Application Programming Interfaces) enable different financial software systems to communicate and share data securely. In decentralized AI banking, they connect various accounts like traditional bank accounts, mobile money services, and crypto wallets, creating a unified financial layer that AI agents can navigate to manage funds and execute transactions across different platforms."
  - question: "How are traditional banks responding to the rise of decentralized AI banking?"
    answer: "Traditional banks recognize the challenge and are actively transforming their operations. They are investing heavily in AI technology, hiring AI experts, and working to modernize their legacy systems. Their goal is to become AI-first technology companies to reduce costs and increase profitability, though they face a race against agile, digitally native decentralized networks."
