...
faqs:
  - question: "What does TPU stand for?"
    answer: "TPU stands for Tensor Processing Unit. It is a custom-designed integrated circuit developed by Google specifically to accelerate machine learning workloads."
  - question: "Why did Google create its own TPU chips?"
    answer: "Google created TPUs to optimize the performance and efficiency of its artificial intelligence services. By designing its own hardware, Google can tailor the chips precisely to the demands of its AI models, gaining a competitive edge in cloud AI."
  - question: "Are Google TPUs used only by Google?"
    answer: "No, Google TPUs are also used by other major AI labs and companies. Organizations like Meta, Anthropic, and Citadel have signed deals to use Google's TPUs for their own AI development and operations."
  - question: "What is the difference between training and inference in AI, and how do TPUs relate?"
    answer: "Training is the process where an AI model learns from data to identify patterns, while inference is when the trained model is used to make predictions or generate outputs. Google's TPUs have historically handled both, but the company is now developing specialized TPUs specifically for inference to meet growing demand."
