...
revised: true
faqs:
  - question: "What does 'crypto' mean in cryptocurrency?"
    answer: "In cryptocurrency, 'crypto' refers to cryptography, the use of advanced mathematics and computer science to secure transactions and verify ownership. It ensures that digital assets cannot be faked, transaction records are immutable, and owners are uniquely identified, rather than implying secrecy."
  - question: "How is cryptocurrency different from traditional money?"
    answer: "Traditional money is typically issued and controlled by central banks and governments, relying on trusted intermediaries like banks for transactions. Cryptocurrency, in contrast, is decentralized, meaning it operates on a global network without a central authority, using blockchain technology to secure and verify transactions directly between participants."
  - question: "Why do cryptocurrencies like Bitcoin have value?"
    answer: "Cryptocurrencies derive value from collective belief, similar to traditional money, but also from their inherent properties. For Bitcoin, its fixed supply limit of 21 million units creates scarcity, while its decentralized nature, security through cryptography, and ease of global transfer contribute to its perceived value as a digital store of value."
  - question: "What are smart contracts?"
    answer: "Smart contracts are self-executing agreements with the terms directly written into code on a blockchain. They automatically execute when predefined conditions are met, without the need for intermediaries. This allows for complex, automated transactions and applications beyond simple currency transfers."
