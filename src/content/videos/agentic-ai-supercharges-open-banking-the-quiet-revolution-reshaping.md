...
faqs:
  - question: "What is Agentic AI in simple terms?"
    answer: "Agentic AI refers to intelligent software systems that can perform complex tasks autonomously. In finance, this means AI agents can manage multi-step financial workflows, like onboarding a customer or assessing loan affordability, without constant human oversight."
  - question: "How does Agentic AI improve financial services?"
    answer: "It improves financial services by automating complex processes, leading to greater efficiency and personalization. These systems can proactively manage finances, offer embedded services, and ensure compliance through structured frameworks, making banking more responsive and accessible."
  - question: "What are the key components needed to deploy Agentic AI securely in banking?"
    answer: "Secure deployment relies on three pillars: Enterprise Data Management and Governance (EDMG) for data integrity, the Domain Agent Model (DAM) for breaking tasks into specialized agents, and Prompt Engineering Architecture Cards (PACE) for setting rules and boundaries for AI behavior."
  - question: "How does Agentic AI address privacy and compliance concerns in finance?"
    answer: "It addresses these concerns through EDMG, which validates data and ensures consent and lineage, and PACE, which translates regulations into enforceable code for AI agents. The Domain Agent Model also allows for easier auditing by breaking down complex tasks into smaller, accountable units."
