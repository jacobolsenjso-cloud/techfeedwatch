...
faqs:
  - question: "What is 'vibe coding'?"
    answer: "'Vibe coding' refers to the practice of using AI coding assistants to quickly generate software prototypes or functional code without deep engineering expertise or proper architectural planning. It often prioritizes speed over long-term stability and maintainability."
  - question: "Can AI replace professional software architects?"
    answer: "No, AI cannot fully replace professional software architects. While AI can generate code, it lacks the contextual understanding, abstract reasoning, and foresight needed to design complex, scalable, secure, and maintainable software systems from the ground up."
  - question: "What is 'technical debt' in the context of AI-generated code?"
    answer: "Technical debt arising from AI-generated code refers to the future cost of rework and maintenance incurred by choosing quick, unoptimized, or poorly architected solutions in the present. This debt accrues when AI-generated code, lacking a holistic design, becomes difficult to integrate, scale, or debug later."
  - question: "How can businesses mitigate the risks of 'vibe coding'?"
    answer: "Businesses can mitigate risks by integrating AI coding tools as assistants for experienced developers, not replacements. They should emphasize strong architectural oversight, code reviews, and invest in developers who understand how to validate, refine, and strategically deploy AI-generated solutions."
---
