...
isShort: false
faqs:
  - question: "What is pre-IPO investment?"
    answer: "Pre-IPO investment involves buying shares in a private company before it makes its initial public offering (IPO). The goal is to gain early access to a company's growth and potentially benefit from a significant increase in value once its stock becomes publicly traded."
  - question: "How can investors gain exposure to pre-IPO companies like SpaceX?"
    answer: "Investors can access pre-IPO opportunities through secondary markets, where existing shareholders sell their vested shares. Another way is by investing in Special Purpose Vehicles (SPVs) that pool money to acquire private company stock. Indirect exposure can also come from certain ETFs and mutual funds that hold stakes in private firms."
  - question: "What are the main risks associated with pre-IPO investing?"
    answer: "Key risks include high demand potentially leading to unfavorable share prices in the private market. Investors also face significant illiquidity, as shares cannot be easily sold until the company goes public, often with additional lockup periods. Furthermore, heavy fees, especially with SPVs, can reduce overall returns."
  - question: "What does it mean to be an accredited investor in this context?"
    answer: "An accredited investor is a regulatory classification for individuals or entities meeting specific income or net worth criteria. This status is often required for direct pre-IPO investments because these private markets are less regulated and carry higher risks. It ensures investors have the financial capacity to absorb potential losses."
