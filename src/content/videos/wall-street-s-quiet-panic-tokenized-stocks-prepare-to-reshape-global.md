...
faqs:
  - question: "What are tokenized stocks?"
    answer: "Tokenized stocks are digital representations of traditional company shares that exist on a blockchain. They allow for ownership of equity to be recorded and transferred using blockchain technology, potentially offering new ways to trade and manage assets."
  - question: "What is the difference between issuer-approved and synthetic tokenization?"
    answer: "Issuer-approved tokenization involves the company itself authorizing the creation of digital tokens that directly mirror its shares, integrating corporate actions like voting and dividends. Synthetic tokenization, however, is done by a third party without the company's consent, where tokens represent a claim on shares held by that third party, often without direct shareholder rights."
  - question: "What are the main risks associated with synthetic tokenized stocks?"
    answer: "Key risks include the potential for 'infinite synthetic supply' leading to fragmented price discovery, de-pegging events if corporate actions are not reflected in the tokens, and systemic risk from their use as collateral in volatile DeFi lending markets. There is also a significant concern about a lack of clear accountability if problems arise."
  - question: "Why is the SEC considering an 'innovation exemption' for tokenized stocks?"
    answer: "The SEC is reportedly considering this exemption to allow crypto exchanges to trade tokenized stocks without requiring permission from the issuing company. This approach draws on precedents like ETFs, which also do not require issuer approval, and aims to explore new technological wrappers for existing securities."
