...
revised: true
faqs:
  - question: "What is the main difference between an AI-native service company and a traditional service company using AI tools?"
    answer: "An AI-native service company is built from the ground up with AI doing most of the work, providing complete, end-to-end outcomes to customers. A traditional service company using AI tools typically integrates AI to assist human workers or improve existing processes, but the core service delivery model remains human-centric."
  - question: "What kind of markets are best suited for AI-native service companies?"
    answer: "Ideal markets are those with low trust (customers already outsource), low judgment at the task level (most steps automatable), a high intelligence threshold (requires both AI and human expertise), and where regulation can be beneficial by raising the bar for quality and accountability. Examples include tax, audit, insurance, and parts of healthcare."
  - question: "Why is 'operational rigor' so important for AI-native service company founders?"
    answer: "AI-native service companies are fundamentally operations businesses. Founders need to understand and manage metrics like variance, throughput, and cycle times. The product itself is designed to automate and optimize these operational processes, making operational expertise crucial for scaling and consistent service delivery."
  - question: "How do AI-native service companies achieve higher profit margins than traditional service firms?"
    answer: "They achieve this through 'AI operating leverage.' As the AI product matures, it automates more tasks, reducing the cost of goods sold (COGS), particularly the reliance on human labor. This allows them to deliver services at a lower cost per unit, leading to gross margins closer to those of software companies, potentially 50% or more, in large service markets."
