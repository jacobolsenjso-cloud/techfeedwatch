...
faqs:
  - question: "What is social engineering in cybersecurity?"
    answer: "Social engineering is a manipulation tactic used by cybercriminals to trick individuals into revealing confidential information or performing actions like transferring money. It involves researching a target to impersonate someone they trust, often using urgency or authority to prompt a quick, unverified response."
  - question: "How has AI changed phishing attacks?"
    answer: "AI has made phishing attacks significantly more potent by removing the friction involved in their creation. It allows cybercriminals to quickly gather vast amounts of personal data, craft highly personalized and convincing messages, and even generate deepfake voices that mimic real individuals, making these attacks much harder to detect."
  - question: "Why is traditional cybersecurity training becoming obsolete?"
    answer: "Traditional cybersecurity training, focused on spotting phishing emails, is becoming obsolete because AI-powered attacks are too sophisticated for human detection. Deepfake voices and highly personalized social engineering tactics are nearly indistinguishable from genuine communications, meaning employees cannot be trained to reliably spot them."
  - question: "What are 'off-brand verification' and 'zero trust' in cybersecurity?"
    answer: "Off-brand verification means using an alternative, trusted communication channel (like a known phone number) to confirm a suspicious request received via email or an unfamiliar call. Zero trust is a cultural approach where employees are encouraged to question authority and urgency regarding sensitive requests, even from superiors, to prevent manipulation."
